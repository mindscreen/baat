...
export class Violation extends BaseHTMLElement<IViolationAccessor> implements IViolationAccessor {
    ...
    updateResult() {
        ...
        if (!this.result) {
            ...
            this.otherTitleRef.value.innerHTML = linkedResults.length > 0 ? "i18n('baat.violation.otherElementsWithErrors')" : "i18n('baat.violation.elementsWithErrors')";
    ...
    initialize() {
        ...
        this.shadowRoot?.appendChild(
            <Accordion id='container' onChange={handleFoldChange}>
                ...
                <div id='description' ref={this.descriptionRef} lang="en"></div>
                <h3 ref={this.highlightTitleRef}>i18n('baat.violation.highlightError')</h3>
                ...
                <p id='info' ref={this.infoRef} lang="en"></p>
