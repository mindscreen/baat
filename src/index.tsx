...
const onError = () => {
    ...
    const dialog = <dialog>
        <h1>i18n('baat.errorDialog.title')</h1>
        <p>i18n('baat.errorDialog.message')</p>
        <button>i18n('baat.buttons.close')</button>
